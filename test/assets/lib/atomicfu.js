(function (root, factory) {
  ...
  var loop = defineInlineFunction('atomicfu.kotlinx.atomicfu.loop_jlk8u1$', function ($receiver, action) {
    while (true) {
      action($receiver.value);
    }
  });
  var update = defineInlineFunction('atomicfu.kotlinx.atomicfu.update_xk4wt8$', function ($receiver, function_0) {
    while (true) {
  ...
  var getAndUpdate = defineInlineFunction('atomicfu.kotlinx.atomicfu.getAndUpdate_xk4wt8$', function ($receiver, function_0) {
    while (true) {
      var cur = $receiver.value;
      var upd = function_0(cur);
      if ($receiver.compareAndSet_xwzc9q$(cur, upd))
  ...
  var updateAndGet = defineInlineFunction('atomicfu.kotlinx.atomicfu.updateAndGet_xk4wt8$', function ($receiver, function_0) {
    while (true) {
      var cur = $receiver.value;
      var upd = function_0(cur);
      if ($receiver.compareAndSet_xwzc9q$(cur, upd))
  ...
  var loop_0 = defineInlineFunction('atomicfu.kotlinx.atomicfu.loop_737bgt$', function ($receiver, action) {
    while (true) {
      action($receiver.value);
    }
  });
  var update_0 = defineInlineFunction('atomicfu.kotlinx.atomicfu.update_4tf4dm$', function ($receiver, function_0) {
    while (true) {
      var cur = $receiver.value;
      var upd = function_0(cur);
  ...
  var getAndUpdate_0 = defineInlineFunction('atomicfu.kotlinx.atomicfu.getAndUpdate_4tf4dm$', function ($receiver, function_0) {
    while (true) {
      var cur = $receiver.value;
      var upd = function_0(cur);
      if ($receiver.compareAndSet_vux9f0$(cur, upd))
  ...
  var updateAndGet_0 = defineInlineFunction('atomicfu.kotlinx.atomicfu.updateAndGet_4tf4dm$', function ($receiver, function_0) {
    while (true) {
      var cur = $receiver.value;
      var upd = function_0(cur);
      if ($receiver.compareAndSet_vux9f0$(cur, upd))
  ...
  var loop_1 = defineInlineFunction('atomicfu.kotlinx.atomicfu.loop_ian79v$', function ($receiver, action) {
    while (true) {
      action($receiver.value);
    }
  });
  var update_1 = defineInlineFunction('atomicfu.kotlinx.atomicfu.update_ifkm8b$', function ($receiver, function_0) {
    while (true) {
      var cur = $receiver.value;
      var upd = function_0(cur);
  ...
  var getAndUpdate_1 = defineInlineFunction('atomicfu.kotlinx.atomicfu.getAndUpdate_ifkm8b$', function ($receiver, function_0) {
    while (true) {
      var cur = $receiver.value;
      var upd = function_0(cur);
      if ($receiver.compareAndSet_3pjtqy$(cur, upd))
  ...
  var updateAndGet_1 = defineInlineFunction('atomicfu.kotlinx.atomicfu.updateAndGet_ifkm8b$', function ($receiver, function_0) {
    while (true) {
      var cur = $receiver.value;
      var upd = function_0(cur);
      if ($receiver.compareAndSet_3pjtqy$(cur, upd))
  ...
  AtomicLong.prototype.lazySet_s8cxhz$ = defineInlineFunction('atomicfu.kotlinx.atomicfu.AtomicLong.lazySet_s8cxhz$', function (value) {
    this.value = value;
  });
  ...
  AtomicLong.prototype.plusAssign_s8cxhz$ = defineInlineFunction('atomicfu.kotlinx.atomicfu.AtomicLong.plusAssign_s8cxhz$', function (delta) {
    this.getAndAdd_s8cxhz$(delta);
  });
  AtomicLong.prototype.minusAssign_s8cxhz$ = defineInlineFunction('atomicfu.kotlinx.atomicfu.AtomicLong.minusAssign_s8cxhz$', function (delta) {
  ...
  Kotlin.defineModule('atomicfu', _);
  return _;
}));
